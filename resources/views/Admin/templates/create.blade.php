...
<!-- Page Header -->
<div class="mb-10">
    <h1 class="font-headline-lg text-headline-lg text-on-surface mb-2">Add New {{ $title }}</h1>
...
<div class="w-full max-w-[90rem]">
    ...
    <div class="bg-surface border border-outline angled-notch p-8 md:p-10 shadow-sm relative group">
        ...
        <form action="{{ route($route . 'store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
