        ...
        <tr class="group hover:bg-surface-variant/10 transition-colors">
            ...
            <td class="px-8 py-6 text-right">
                <div class="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <a href="{{ route('admin.events.show', $item->id) }}" class="p-2 hover:bg-surface-variant rounded-lg text-on-surface-variant transition-colors" title="View Event Details">
